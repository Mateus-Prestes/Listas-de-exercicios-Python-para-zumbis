...
def maior_ponta(nums):
  maior_pon = []
  if nums[0] > nums[-1]:
    maior_pon.extend((nums[0], nums[0], nums[0]))
  elif nums[-1] > nums[0]:
    maior_pon.extend((nums[-1], nums[-1], nums[-1]))
  elif nums[-1] == nums[0]:
    maior_pon.extend((nums[-1], nums[-1], nums[-1]))
  return maior_pon
...
def squirrel_play(temp, is_summer):
  if temp > 60 and temp <= 90:
    ...
    return True
  elif temp > 60 and temp <= 100 and is_summer == False:
    return False
  elif temp > 60 and temp > 100 and is_summer == True:
    return False
  elif temp < 100 and is_summer == False:
    return True
# I. pego_correndo
...
def pego_correndo(speed, is_birthday):
  ...
  if speed > 61 and speed <= 80:
    ...
    return 2
  elif speed > 80 and is_birthday == True:
    return 1
...
def alarm_clock(day, vacation):
  if day > 0 and day <= 5 and vacation == False:
    return '7:00'
  elif day > 0 and day <= 5 and vacation == True:
    return '10:00'
